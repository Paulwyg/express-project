...
namespace Wlst.iif
{
    ...
    {
        public Wlst.iif.Head Head { get; set; }
    ...
    public partial class RtuRunningInfo
    {
        ...
        public List<Wlst.iif.RtuRunningInfo.RtuRunningInfoOne> Items { get; set; }

        public Wlst.iif.RtuRunningInfo.RtuRunningError RunningError { get; set; }
    ...
    public partial class Online
    {
        ...
        public List<Wlst.iif.Online.OnlineItem> Items { get; set; }
    ...
    public partial class UserInfoBk
    {
        ...
        public List<Wlst.iif.UserInfoBk.UserInfo> Items { get; set; }
    ...
    public partial class RoleInfoBk
    {
        ...
        public List<Wlst.iif.RoleInfoBk.RoleInfo> Items { get; set; }
    ...
    public partial class AddRoleInfo
    {
        ...
        /// <summary> 角色信息</summary>
        public Wlst.iif.RoleInfoBk.RoleInfo Info { get; set; }
    ...
    public partial class RoleUserInfoBk
    {
        ...
        /// <summary>角色信息</summary>
        public Wlst.iif.RoleInfoBk.RoleInfo UserRole { get; set; }
    ...
    public partial class AddPlanBatchOperationInfo
    {
        ...
        public List<Wlst.iif.AddPlanBatchOperationInfo.PlanInfoAdd> ItemsPlan { get; set; }
    ...
    public partial class PlanBatchOperationInfo
    {
        ...
        /// <summary> 信息列表</summary>
        public List<Wlst.iif.PlanBatchOperationInfo.PlanInfo> ItemsPlan { get; set; }
    ...
    public partial class PlanBatchOperationInfoBk
    {
        ...
        public List<Wlst.iif.PlanBatchOperationInfo> ItemsPlan { get; set; }
    ...
    public partial class PlanRtuTimetableInfo
    {
        ...
        public List<Wlst.iif.PlanRtuTimetableInfo.PlanTimeTableInfo> ItemsSelect { get; set; }
    ...
    public partial class PlanRtuTimetableInfoBk
    {
        ...
        public List<Wlst.iif.PlanRtuTimetableInfoBk.PlanGrpInfo> ItemsPlan { get; set; }
    ...
    {
        /// <summary>需要解析的选择的分组或时间表分组</summary>
        public List<Wlst.iif.PlanGrpTransRtu.PlanGrpInfo> ItemsPlan { get; set; }
    ...
    public partial class PlanGrpTransRtuBk
    {
        ...
        public List<Wlst.iif.PlanGrpTransRtuBk.PlanGrpTransRtuBkItem> PlanRtuItems { get; set; }
    ...
    public partial class QueryRtuBirefBk
    {
        ...
        public Wlst.iif.QueryRtuBiref QueryInfo { get; set; }

        /// <summary> 区域列表</summary>
        public List<Wlst.iif.QueryRtuBirefBk.AreaInfoBrief> ItemsArea { get; set; }

        /// <summary> 分组列表</summary>
        public List<Wlst.iif.QueryRtuBirefBk.GroupInfoBreif> ItemsGroup { get; set; }

        /// <summary> 终端列表</summary>
        public List<Wlst.iif.QueryRtuBirefBk.RtuInfoBiref> ItemsRtu { get; set; }
    ...
    public partial class AreaInfo
    {
        ...
        /// <summary> 终端列表</summary>
        public List<Wlst.iif.RtuInfo> ItemsRtu { get; set; }
    ...
    public partial class AreasInfo
    {
        ...
        public List<Wlst.iif.AreaInfo> ItemsArea { get; set; }
    ...
    public partial class GroupsInfo
    {
        ...
        /// <summary> 组信息</summary>
        public List<Wlst.iif.GroupInfo> ItemsGroup { get; set; }
    ...
    public partial class SluCtrlAndGrpbriefInfo
    {
        ...
        /// <summary> 组信息</summary>
        public List<Wlst.iif.SluCtrlAndGrpbriefInfo.SluGroupbriefInfoItem> ItemsGroup { get; set; }
        ...
        public partial class SluGroupbriefInfoItem
        {
            ...
            public List<Wlst.iif.SluCtrlAndGrpbriefInfo.SluCtrlbriefInfoItem> Ctrls { get; set; }
    ...
    public partial class RtuOnlineInfo
    {
        ...
        public List<Wlst.iif.RtuOnlineInfo.RtuOnlineInfoOne> Items { get; set; }
    ...
    public partial class RtuMeasureInfo
    {
        ...
        public Wlst.iif.RtuMeasureInfo.RtuMeasureInfoOne Items { get; set; }

        /// <summary>回路信息</summary>
        public List<Wlst.iif.RtuMeasureInfo.RtuLoopInfo> ItemsLoop { get; set; }

        /// <summary>开关量输出信息</summary>
        public List<Wlst.iif.RtuMeasureInfo.RtuSwitchOutInfo> ItemsSwitchOut { get; set; }
    ...
    public partial class RtusMeasureInfo
    {
        ...
        public List<Wlst.iif.RtuMeasureInfo> ItemsRtu { get; set; }
    ...
    public partial class RtuMeasureDayInfoBk
    {
        ...
        /// <summary> 设备物理地址</summary>
        public List<Wlst.iif.RtuMeasureDayInfoBk.RtuInfo> Items { get; set; }
        ...
        public partial class RtuInfo
        {
            public List<Wlst.iif.RtuMeasureDayInfoBk.RtuLoopInfo> Items { get; set; }
    ...
    public partial class AnsRtuOrderRtuPara
    {
        ...
        public List<Wlst.iif.AnsRtuOrderRtuPara.ZcRtuSwitchOutInfo> SwitchOutInfo { get; set; }

        /// <summary> 回路信息</summary>
        public List<Wlst.iif.AnsRtuOrderRtuPara.ZcRtuLoopInfo> LoopInfo { get; set; }
    ...
    public partial class AnsZcRtuWeekTimeSet
    {
        ...
        /// <summary> 回路信息</summary>
        public List<Wlst.iif.AnsZcRtuWeekTimeSet.ZcOneLoopOneWeekTime> Info { get; set; }
    ...
    public partial class RtuOpenCloseLightCenter
    {
        ...
        public List<Wlst.iif.RtuOpenCloseLightCenter.RtuOpenCloseLightCenterItem> Items { get; set; }
    ...
    public partial class GetRtusHisweeksetbk
    {
        ...
        /// <summary>终端列表 无数据则表示所有终端</summary>
        public List<Wlst.iif.GetRtusHisweeksetbk.GetRtusHisweeksetbkItem> Itemsdata { get; set; }
    ...
    public partial class CurErrorDelete
    {
        ...
        public List<Wlst.iif.CurErrorDelete.CurErrorItem> Items { get; set; }
    ...
    public partial class SetAlarmErrInfo
    {
        ...
        public List<Wlst.iif.SetAlarmErrInfo.AlarmErrInfoView> ErrInfoView { get; set; }
    ...
    public partial class CurFault
    {
        ...
        /// <summary>调用接口时 作为参数  可不填入数据的，接口返回服务器端填写使用</summary>
        public List<Wlst.iif.CurFault.CurFaultItem> Errs { get; set; }
    ...
    public partial class PreFault
    {
        ...
        /// <summary>调用接口时 作为参数  可不填入数据的，接口返回服务器端填写使用</summary>
        public List<Wlst.iif.PreFault.PreFaultItem> Errs { get; set; }
    ...
    public partial class TimetablePlanBandingInfo
    {
        ...
        public List<Wlst.iif.TimetablePlanBandingInfo.TimePlanBandingInfo> ItemsBanding { get; set; }

        /// <summary> 区域地址</summary>
        public int AreaId { get; set; }

        /// <summary> 方案扼要列表</summary>
        public List<Wlst.iif.TimetablePlanBandingInfo.TimePlanInfoBrief> ItemsPlan { get; set; }
    ...
    public partial class TimetablePlanBandingSpecialPlanInfoSave
    {
        ...
        public List<Wlst.iif.TimetablePlanBandingSpecialPlanInfoSave.PlanInfoBandingSpecialPlan> ItemsBanding { get; set; }
    ...
    public partial class TimetablePlanInfoBrief
    {
        ...
        /// <summary> 方案信息列表</summary>
        public List<Wlst.iif.TimetablePlanInfoBrief.TimePlanInfoBrief> ItemsTimePlan { get; set; }

        /// <summary> 特设方案信息</summary>
        public List<Wlst.iif.TimetablePlanInfoBrief.SpecialTimePlanInfoBrief> ItemsSpecialPlan { get; set; }
    ...
    public partial class OneRtuPlanInfo
    {
        ...
        public List<Wlst.iif.OneRtuPlanInfo.TimeTableOnedayPlan> ItemsSet { get; set; }
        ...
        public List<Wlst.iif.OneRtuPlanInfo.LuxParaInfoItem> ItemsLux { get; set; }
    ...
    public partial class AddOrUpdateRtuPlanInfo
    {
        ...
        /// <summary> 包含的开关灯规则</summary>
        public List<Wlst.iif.AddOrUpdateRtuPlanInfo.TimeTableOnedayPlan> ItemsSet { get; set; }
    ...
    public partial class OneSpecialRtuTimePlanInfo
    {
        ...
        public List<Wlst.iif.OneSpecialRtuTimePlanInfo.SpecialTimePlanInfo> ItemsSpecial { get; set; }

        /// <summary> 特设方案绑定列表</summary>
        public List<int> ItemsBanding { get; set; }

        /// <summary>辅助参数 一年的日出日落时间，时间为 hour*60+minutes</summary>
        public List<Wlst.iif.OneSpecialRtuTimePlanInfo.SunSetRiseInfoItem> ItemsSunRiseSet { get; set; }
    ...
    public partial class AddOrUpdateSpecialRtuTimePlanInfo
    {
        ...
        /// <summary> 特设方案信息列表</summary>
        public List<Wlst.iif.AddOrUpdateSpecialRtuTimePlanInfo.SpecialTimePlanInfo> ItemsSpecial { get; set; }
    ...
    public partial class GetRecordTypesBk
    {
        ...
        public List<Wlst.iif.GetRecordTypesBk.RecordTypesItem> Items { get; set; }
    ...
    public partial class OpRecord
    {
        ...
        /// <summary>调用接口时 作为参数  可不填入数据的，接口返回服务器端填写使用</summary>
        public List<Wlst.iif.OpRecord.OpRecordItem> Items { get; set; }
    ...
    public partial class SysInfo
    {
        ...
        public List<Wlst.iif.SysInfo.SysInfoView> SysInfoField { get; set; }

        /// <summary>服务器运行情况</summary>
        public List<Wlst.iif.SysInfo.AppInfoView> AppOursInfo { get; set; }

        /// <summary>关键进行运行情况</summary>
        public List<Wlst.iif.SysInfo.AppInfoView> AppAllInfo { get; set; }
    ...
    public partial class ControlSuccessRate
    {
        ...
        public List<Wlst.iif.ControlSuccessRate.ControlSuccessRateItem> Items { get; set; }
    ...
    public partial class RtuElecDay
    {
        ...
        public List<Wlst.iif.RtuElecDay.RtuElecTotal> Items { get; set; }
    ...
    public partial class RtuElecRtu
    {
        ...
        public List<Wlst.iif.RtuElecRtu.RtuElecItem> Items { get; set; }
    ...
    public partial class FaultStatisticsDay
    {
        ...
        public List<Wlst.iif.FaultStatisticsDay.FaultStatistics> Items { get; set; }
    ...
    public partial class FaultStatisticsRtu
    {
        ...
        public List<Wlst.iif.FaultStatisticsRtu.FaultStatisticsItem> Items { get; set; }
    ...
    public partial class RtuDataStatistics
    {
        ...
        public List<Wlst.iif.RtuDataStatistics.RtuDataStatisticsItem> Items { get; set; }
    ...
    public partial class SluLightOnRate
    {
        ...
        public List<Wlst.iif.SluLightOnRate.SluLightOnRateItem> Items { get; set; }
    ...
    public partial class EquipmentInfoType
    {
        ...
        public List<Wlst.iif.EquipmentInfoTypeItem> ItemType { get; set; }
    ...
    public partial class RtuPara
    {
        ...
        /// <summary>调用接口时 作为参数  可不填入数据的，接口返回服务器端填写使用</summary>
        public Wlst.iif.RtuEquipmentBase Baseinfo { get; set; }

        public List<Wlst.iif.RtuPara.RtuAnalogParameter> LoopsInfo { get; set; }

        /// <summary>照明回路参数</summary>
        public List<Wlst.iif.RtuPara.RtuSwitchInputParameter> InputsInfo { get; set; }

        /// <summary>门类的输入参数</summary>
        public List<Wlst.iif.RtuPara.RtuSwitchOutputParameter> OutputsInfo { get; set; }
    ...
    public partial class ReplygtSludataCon
    {
        ...
        public List<Wlst.iif.ReplygtSludataCon.DataSluCon> ItemsData { get; set; }
        ...
        public partial class DataSluCon
        {
            ...
            public List<Wlst.iif.ReplygtSludataCon.DataSluConPlanInfo> ItemsPlan { get; set; }
    ...
    public partial class ReplygtSludataMeasure
    {
        ...
        public List<Wlst.iif.ReplygtSludataCon.DataSluCon> SluData { get; set; }
    ...
    public partial class SluCtrlDataMeasure
    {
        ...
        public Wlst.iif.SluCtrlDataMeasure.DataSluCtrl Info { get; set; }

        public List<Wlst.iif.SluCtrlDataMeasure.DataSluCtrlLamp> Items { get; set; }
    ...
    public partial class ReplygtSludataLamp
    {
        ...
        public List<Wlst.iif.SluCtrlDataMeasure> Data { get; set; }
    ...
    public partial class ReplygtSludataCtrpPhyInfo
    {
        ...
        public List<Wlst.iif.CtrlPhyinfo> Data { get; set; }
    ...
    public partial class AssistCtrlData
    {
        ...
        public List<Wlst.iif.AssistCtrlData.LightData> LightDataField { get; set; }
    ...
    public partial class ReplygtSluAssistCtrlDataMeasure
    {
        ...
        public List<Wlst.iif.AssistCtrlData> Data { get; set; }
    ...
    public partial class SluCtrlParaRead
    {
        ...
        public List<Wlst.iif.SluCtrlParaRead.SluCtrlParaReadItem> Items { get; set; }
    ...
    {
        public List<Wlst.iif.SluRightOperators.SluRightOperator> OperatorItems { get; set; }
    ...
    public partial class SluRightOperatorReply
    {
        ...
        public List<Wlst.iif.SluRightOperatorReply.SluRightOperatorReplyItem> Items { get; set; }
    ...
    public partial class SluTimeRead
    {
        ...
        public List<Wlst.iif.SluTimeRead.SluTimeReadItem> Iems { get; set; }
    ...
    public partial class ResetAndInitReply
    {
        ...
        public Wlst.iif.ResetAndInit ZcSetResetAndInit { get; set; }
    ...
    public partial class SluSetAndReadReplyTwo
    {
        ...
        public Wlst.iif.SluSetAndReadReplyTwo.JzqTimeInfo ZcJzqTime { get; set; }
    ...
    public partial class SluSetAndReadReplyThree
    {
        ...
        public Wlst.iif.SluSetAndReadReplyThree.JzqPara ZcJzqPara { get; set; }
    ...
    public partial class SluSetAndReadReplyFour
    {
        ...
        public Wlst.iif.SluSetAndReadReplyFour.JzqAlarmPara ZcJzqAlarmPara { get; set; }
    ...
    public partial class SluCtrlArgsReplyOne
    {
        ...
        public Wlst.iif.SluCtrlArgsReplydata.CtrlData CtrlDataField { get; set; }

        /// <summary>控制器数据（新）</summary>
        public List<Wlst.iif.SluCtrlArgsReplydata.CtrlDataNew> CtrlDataNewField { get; set; }
    ...
    public partial class SluCtrlArgsReplyTwo
    {
        ...
        public Wlst.iif.SluCtrlArgsReplydata.CtrlVer CtrlVerField { get; set; }
    ...
    public partial class SluCtrlArgsReplyThree
    {
        ...
        public Wlst.iif.SluCtrlArgsReplydata.CtrlPara CtrlParaField { get; set; }

        /// <summary>控制器当日日出日落</summary>
        public Wlst.iif.SluCtrlArgsReplydata.CtrlSunriseset CtrlSunrisesetField { get; set; }
    ...
    public partial class SluCtrlArgsReplyFour
    {
        ...
        public List<Wlst.iif.SluCtrlArgsReplydata.CtrlRuntime> CtrlRuntimeField { get; set; }
    ...
    public partial class SluCtrlArgsReplydata
    {
        public partial class CtrlData
        {
            ...
            public Wlst.iif.SluCtrlArgsReplydata.CtrlStatus CtrlStatus { get; set; }

            /// <summary>灯状态</summary>
            public List<Wlst.iif.SluCtrlArgsReplydata.LightStatus> LightStatus { get; set; }
    ...
    public partial class LuxDataBk
    {
        ...
        public List<Wlst.iif.LuxDataBk.LuxDataItem> Info { get; set; }
    ...
    public partial class TimeTableReportRecordBk
    {
        ...
        public List<Wlst.iif.TimeTableReportRecordBk.TimeTableReportRecordItem> Items { get; set; }
    ...
    public partial class TimeTableReportRecordDetailBk
    {
        ...
        public List<Wlst.iif.TimeTableReportRecordDetailBk.RtuOpInfo> Items { get; set; }
    ...
    public partial class RecordWeekTimeBk
    {
        ...
        /// <summary> 详细结果</summary>
        public List<Wlst.iif.RecordWeekTimeBk.RtuOpInfo> Items { get; set; }
    ...
    public partial class SunRiseSetInfo
    {
        ...
        /// <summary> 数据</summary>
        public List<Wlst.iif.SunRiseSetInfo.SunRiseItem> Items { get; set; }
    ...
    {
        public List<Wlst.iif.MsgRecordBk.MsgRecordItem> Items { get; set; }
    ...
    public partial class SluPlanGrpInfoBk
    {
        ...
        public List<Wlst.iif.SluPlanGrpInfoBk.SluPlanGrpItemInfo> Items { get; set; }
        ...
        public partial class SluPlanCtrlGrpSluItemInfo
        {
            ...
            public List<Wlst.iif.SluPlanGrpInfoBk.SluCtrlGrpSelectedItem> GrpItems { get; set; }
        ...
        public partial class SluPlanGrpItemInfo
        {
            ...
            public List<Wlst.iif.SluPlanGrpInfoBk.SluPlanCtrlGrpSluItemInfo> Items { get; set; }
    ...
    public partial class SluPlanGrpSave
    {
        ...
        public List<Wlst.iif.SluPlanGrpSave.SluGrpSaveSelectedItem> Items { get; set; }
    ...
    public partial class SluPlanBriefInfo
    {
        ...
        public List<Wlst.iif.SluPlanBriefInfo.SluPlanItemBriefInfo> Items { get; set; }
    ...
    public partial class SluPlanDetailInfo
    {
        ...
        public List<Wlst.iif.SluPlanDetailInfo.LuxInfo> Luxitems { get; set; }
    ...
    public partial class SluPlanBandingInfo
    {
        ...
        public List<Wlst.iif.SluPlanBandingInfo.SluPlanBandingBriefInfo> Items { get; set; }
    ...
    public partial class SluPlanBandingDetailInfo
    {
        ...
        public List<Wlst.iif.SluPlanBandingDetailInfo.TimePlanBandingGrpItem> Items { get; set; }
    ...
    public partial class SluTimePlanRecord
    {
        ...
        public List<Wlst.iif.SluTimePlanRecord.SluSluTimePlanSendInfo> Items { get; set; }
    ...
    public partial class SluPara
    {
        ...
        public Wlst.iif.SluPara.SluParameter Para { get; set; }

        /// <summary>控制器参数信息</summary>
        public List<Wlst.iif.SluPara.SluCtrlPara> ItemsCtrls { get; set; }

        /// <summary>控制器分组信息</summary>
        public List<Wlst.iif.SluPara.SluCtrlGroupPara> ItemsGrp { get; set; }
        ...
        public partial class SluCtrlGroupPara
        {
            ...
            public List<Wlst.iif.SluPara.SluCtrlGroupPara.SluCtrlBriefPara> Items { get; set; }
    ...
    public partial class UserShowFontInfo
    {
        ...
        public Wlst.iif.UserShowFontInfo.UserShowFont UserSfo { get; set; }
    ...
    public partial class RelatedRtus
    {
        ...
        public List<Wlst.iif.RtuInfo> RtuItems { get; set; }
    ...
    public partial class RtusState
    {
        ...
        public List<Wlst.iif.RtusState.RtuStateInfo> RtuItems { get; set; }
    ...
    public partial class SluStatusReturn
    {
        ...
        public List<Wlst.iif.SluStatusReturn.SluStatus> SluStatusField { get; set; }

        public partial class SluStatus
        {
            public int SluId { get; set; }

            public List<Wlst.iif.SluStatusReturn.SluStatus.SluCtrlStatus> CtrlStatus { get; set; }
    ...
    public partial class RtuLoopHistory
    {
        ...
        public List<Wlst.iif.RtuLoopHistory.RtuLoopData> LoopItems { get; set; }
    ...
    public partial class TopCurFaultInfo
    {
        ...
        public List<Wlst.iif.TopCurFaultInfo.TopCurFaultItem> CurErrs { get; set; }
    ...
    public partial class BrightRateTrendInfo
    {
        ...
        public List<Wlst.iif.BrightRateTrendInfo.BrightRateTrendItem> Items { get; set; }
    ...
    public partial class EquOnlineInfo
    {
        ...
        public List<Wlst.iif.EquOnlineInfo.EquOnlineItem> OnlineItems { get; set; }
    ...
    {
        public List<Wlst.iif.FaultResponseInfo.FaultResponseItem> FaultResponseItems { get; set; }
    ...
    {
        public List<Wlst.iif.NewFaultInfo.NewFaultItem> NewFaultItems { get; set; }
    ...
    {
        public List<Wlst.iif.EquActiveInfo.EquActiveItem> EquActiveItems { get; set; }
    ...
    public partial class HomePageData
    {
        ...
        public Wlst.iif.OpenCloseTimeInfo OpenCloseTime { get; set; }

        /// <summary>当前故障top5的类型和数量</summary>
        public Wlst.iif.TopCurFaultInfo TopCurFault { get; set; }

        /// <summary>故障响应率</summary>
        public Wlst.iif.FaultResponseInfo FaultReponse { get; set; }

        /// <summary>最新故障</summary>
        public Wlst.iif.NewFaultInfo NewFault { get; set; }

        /// <summary>设备活跃率</summary>
        public Wlst.iif.EquActiveInfo EquActive { get; set; }
    ...
    public partial class GisGetTableInfo
    {
        ...
        public List<Wlst.iif.GisGetTableInfo.GisTableInfo> TableInfos { get; set; }
    ...
    public partial class LeakPara
    {
        ...
        public List<Wlst.iif.LeakPara.LeakParaItem> Items { get; set; }
    ...
    public partial class RequestLeakData
    {
        ...
        public List<Wlst.iif.RequestLeakData.LeakNewData> Items { get; set; }
        ...
        public partial class LeakNewData
        {
            ...
            public List<Wlst.iif.RequestLeakData.LeakNewData.LeakNewDataItem> Items { get; set; }
    ...
    public partial class LeakZcWorkArgs
    {
        ...
        public List<Wlst.iif.LeakZcWorkArgs.LeakZcWorkArgsItem> Items { get; set; }
    ...
    public partial class RequestLuxData
    {
        ...
        /// <summary>返回的数据</summary>
        public List<Wlst.iif.RequestLuxData.LuxDataItem> Items { get; set; }
    ...
    public partial class RequestMruData
    {
        ...
        /// <summary>返回的数据</summary>
        public List<Wlst.iif.RequestMruData.MruDataItem> Items { get; set; }
    ...
    public partial class RequestMruStatisticsData
    {
        ...
        /// <summary>返回的数据</summary>
        public List<Wlst.iif.RequestMruStatisticsData.MruStatisticsDataItem> Items { get; set; }
    ...
    public partial class RequestMruFailData
    {
        ...
        /// <summary>返回的数据</summary>
        public List<Wlst.iif.RequestMruFailData.MruFailDataItem> Items { get; set; }
    ...
    public partial class LduPara
    {
        ...
        public List<Wlst.iif.LduPara.LduLinePars> ItemsPara { get; set; }
    ...
    public partial class LduZcPara
    {
        ...
        /// <summary>控制器参数</summary>
        public List<Wlst.iif.LduZcPara.LduLinePars> ItemsPara { get; set; }
    ...
    public partial class RequestLduData
    {
        ...
        /// <summary>返回的数据</summary>
        public List<Wlst.iif.RequestLduData.LduLineDataItem> Items { get; set; }
    ...
    public partial class LduBrightLightSetOrZc
    {
        ...
        public List<Wlst.iif.LduBrightLightSetOrZc.LduLineBrightLightData> ItemsBrightLight { get; set; }
    ...
    public partial class EquimentRemarkReturn
    {
        ...
        public List<Wlst.iif.EquimentRemarkReturn.SingleEquimentRemark> EquRemark { get; set; }
    ...
    {
        public List<Wlst.iif.EquimentRemarkSave.SingleEquimentRemark> EquRemark { get; set; }
    ...
    public partial class SluSglCtrlParaReturn
    {
        ...
        public List<Wlst.iif.SluSglCtrlParaReturn.SingleSluSglCtrlPara> SluSglCtrlPara { get; set; }

        public List<Wlst.iif.SluSglCtrlParaReturn.SluSglFieldList> SluSglField { get; set; }
    ...
    {
        public List<Wlst.iif.SluSglCtrlParaSave.SingleSluSglCtrlPara> SluSglCtrlPara { get; set; }
    ...
    public partial class MsgWithIif
    {
        ...
        public Wlst.iif.GetRtusWeekTimeInfo GetRtusWeekTimeInfoGet { get; set; }

        /// <summary> 返回指定终端指定时间段内的周设置</summary>
        public List<Wlst.iif.RtuWeekTimeInfo> RtuWeekTimeInfoBack { get; set; }

        /// <summary> 南瑞单灯 设置/读取经纬度以及开关灯偏移时间</summary>
        public Wlst.iif.NRSetOrZcTudeAndDeviation NROrder1004 { get; set; }

        /// <summary> 南瑞单灯 设置/读取经纬度</summary>
        public Wlst.iif.NRSetOrZcLongitudeAndLatitude NROrder1010 { get; set; }

        /// <summary> 南瑞单灯 设置/读取控制器id以及灯头分组</summary>
        public Wlst.iif.NRSetOrZcCtrlPara NROrder1030 { get; set; }

        /// <summary> 南瑞单灯 选测单灯控制器</summary>
        public Wlst.iif.NRMeasure NROrder1032 { get; set; }

        /// <summary> 南瑞单灯 单灯控制</summary>
        public Wlst.iif.NROcLight NROrder1033 { get; set; }

        /// <summary> 南瑞单灯 组控制</summary>
        public Wlst.iif.NRGroupOcLight NROrder1034 { get; set; }

        /// <summary> 南瑞单灯 设置/读取组策略（时间表）</summary>
        public Wlst.iif.NRSetOrZcTimeTable NROrder1035 { get; set; }
    ...
    public partial class GetRtusWeekTimeInfo
    {
        ...
        /// <summary> 时间 java时间，可以查询一天或者几天的数据 （每个时间精确到 年月日即可）</summary>
        public List<long> DtTimes { get; set; }
    ...
    public partial class RtuWeekTimeInfo
    {
        ...
        public List<Wlst.iif.RtuWeekTimeInfo.OneDayWeekTime> InfoItems { get; set; }
        ...
        public partial class OneDayWeekTime
        {
            ...
            /// <summary> K1-Kx的第一段开关时间 hhmm-hhmm</summary>
            public List<string> WeekTimeInfo1 { get; set; }

            /// <summary> K1-Kx的第二段开关时间 hhmm-hhmm</summary>
            public List<string> WeekTimeInfo2 { get; set; }

            /// <summary> K1-Kx的第三段开关时间 hhmm-hhmm</summary>
            public List<string> WeekTimeInfo3 { get; set; }

            /// <summary> K1-Kx的第四段开关时间 hhmm-hhmm</summary>
    ...
    /// <summary>广州南瑞单灯设置/读取经纬度</summary>
    ...
    /// <summary>广州南瑞单灯设置/读取控制器id以及灯头分组</summary>
    public partial class NRSetOrZcCtrlPara
    {
        ...
        /// <summary> 1 设置，2 读取 默认2</summary>
        public int SluitemNum { get; set; }

        /// <summary> 控制器数量  读取时每次不超过50个</summary>
        public List<Wlst.iif.NRSetOrZcCtrlPara.SluitemConfig> SluitemConfigField { get; set; }

        /// <summary> 控制器配置信息</summary>
        public partial class SluitemConfig
        {
            public long SluitemId { get; set; }

            /// <summary> 控制器标识</summary>
    ...
    public partial class NRMeasure
    {
        ...
        /// <summary>
        /// <para>设备逻辑地址</para>
        /// <para> 要读取的控制器数量，最大50（下行） 0-全部 1-单个，在ctrl_id中填入控制器地址</para>
        /// </summary>
        public int SluitemNum { get; set; }

        public int CtrlId { get; set; }

        /// <summary> 控制器地址（下行）</summary>
        public List<Wlst.iif.NRMeasure.SluitemData> SluitemDataField { get; set; }

        /// <summary> 控制器数据(服务端应答)</summary>
        public partial class SluitemData
        {
            public long SluitemId { get; set; }

            /// <summary> 控制器地址</summary>
            public Wlst.iif.NRMeasure.SluitemStatus SluitemStatus { get; set; }

            /// <summary> 控制器状态</summary>
            public double SluitemVoltage { get; set; }

            /// <summary> 控制器电压</summary>
            public double LeakageCurrent { get; set; }

            /// <summary> 漏电流</summary>
            public double LampVoltage { get; set; }

            /// <summary> 灯杆电压</summary>
            public int SluitemLamps { get; set; }

            /// <summary> 灯头数量</summary>
            public List<Wlst.iif.NRMeasure.LampData> LampData { get; set; }

        }

        public partial class SluitemStatus
        {
            public List<int> LampStatus { get; set; }

            /// <summary> 依次3个灯头的开关状态，0-关灯，1-开灯</summary>
            public int SluitemOffline { get; set; }

        }

        public partial class LampData
        {
            public double Current { get; set; }
    ...
    public partial class NROcLight
    {
        ...
        /// <summary>
        /// <para>设备逻辑地址</para>
        /// <para>要控制的控制器数量，最大50（下行） 0-全部 1-单个，在ctrl_id中填入控制器地址</para>
        /// </summary>
        public int SluitemNum { get; set; }

        /// <summary> 控制器数量，最大50</summary>
        public int CtrlId { get; set; }

        /// <summary> 控制器地址</summary>
        public List<Wlst.iif.NROcLight.SluitemCtrl> SluitemCtrlField { get; set; }

        public partial class SluitemCtrl
        {
            public long SluitemId { get; set; }
            ...
            /// <summary> 灯头数量</summary>
            public List<int> LampsCtrl { get; set; }

        }

    }

    /// <summary>广州南瑞单灯组控制</summary>
    public partial class NRGroupOcLight
    {
        ...
        /// <summary> 组数量</summary>
        public List<Wlst.iif.NRGroupOcLight.GroupCtrl> GroupCtrlField { get; set; }

        public partial class GroupCtrl
        {
            public int GroupId { get; set; }

            /// <summary> 组id，0-255</summary>
            public int GroupDo { get; set; }
    ...
    public partial class NRSetOrZcTimeTable
    {
        ...
        /// <summary> 组数量,最大64</summary>
        public int Op { get; set; }

        /// <summary> 1 设置，2 读取 默认2</summary>
        public List<Wlst.iif.NRSetOrZcTimeTable.GroupConfig> GroupConfigField { get; set; }
        ...
        public partial class GroupConfig
        {
            ...
            public List<Wlst.iif.NRSetOrZcTimeTable.LampSetup> LampSetup { get; set; }
        ...
        public partial class LampSetup
        {
            ...
            /// <summary> 0-关灯，1～100-开灯以及亮度</summary>
