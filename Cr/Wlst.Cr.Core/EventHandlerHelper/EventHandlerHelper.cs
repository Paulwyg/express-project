...
//        {
//            Wlst.Cr.Coreb.Servers.EventPublish.AddEventTokener(this.GetType().GUID + "", FundEventHandler,
...
//        {
//            Wlst.Cr.Coreb.Servers.EventPublish.UnsubscribeEvent( this.GetType().GUID + "");
//        }
...
//        internal static  ConcurrentDictionary<string, int> _tmp3 = new ConcurrentDictionary<string, int>();
...
//                {
//                    WriteLog.WriteError("Event Need Runin Ui :" + f.Key);
//                }
//            }
//        }
