...
namespace Wlst.Cr.CoreOne
{
    [ModuleExport(typeof(CrCoreOne), DependsOnModuleNames = new string[] { "CrCore" })]
    public class CrCoreOne : IModule, IPartImportsSatisfiedNotification
    {
