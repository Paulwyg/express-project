...
namespace Wlst.Cr.Coreb.Config
{
    internal class ConfigFilePath
    {

        public static string Log4NetSystemtConfigFilePath 
        {
            get
            {
                string strPath = @"Config\Log.xml";
                if (!System.IO.File.Exists(strPath))
                {
                    ...
                    catch (Exception ex)
                    {
                        ...
                        Console.WriteLine("Log Config Path Error:"+ex );
                    }
                }
                return strPath;
            }
