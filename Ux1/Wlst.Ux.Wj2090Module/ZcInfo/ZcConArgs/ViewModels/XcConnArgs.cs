...
using Wlst.Ux.Wj2090Module.ZcInfo.ZcConArgs.Services;
using Wlst.Cr.CoreMims.Services;
using Wlst.Sr.EquipmentInfoHolding.Services;
using System.Collections.ObjectModel;

namespace Wlst.Ux.Wj2090Module.ZcInfo.ZcConArgs.ViewModels
{
    ...
    public partial class XcConnArgs
    {
        ...
        private void ActiveView()
        {
            Wlst.Cr.Core.CoreServices.RegionManage.ShowViewByIdAttachRegion(
                Wj2090Module.Services.ViewIdAssign.ZcConnArgsViewId, true);
        }
        ...
        private ICommand _cmdCmdReadArgs;
            ...
            private void ExCmdReadArgs()
            {
                ...
                //lvf 记录 召测终端 2018年8月13日14:58:40
