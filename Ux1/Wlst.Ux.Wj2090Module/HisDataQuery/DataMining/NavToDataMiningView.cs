...
namespace Wlst.Ux.Wj2090Module.HisDataQuery.DataMining
{
    ...
    public class NavToDataMiningView : MenuItemBase
    {
        ...
        {
            Id = Wj2090Module.Services.MenuIdAssign.NavToDataMiningViewId;
                // Infrastructure.IdAssign.MenuIdAssign.NavToEquipmentDailyDataQueryViewId;
            Text = "单灯电量统计";
            Tag = "单灯电量统计";
            this.Classic = "主菜单";
            Description = "单灯电量统计，ID 为" + Wj2090Module.Services.MenuIdAssign.NavToDataMiningViewId;
                // Infrastructure.IdAssign.MenuIdAssign.NavToEquipmentDailyDataQueryViewId;
            Tooltips = "单灯电量统计";
            base.IsEnabled = true;
        ...
        protected void Ex()
        {
            this.ExNavWithArgs(
                //ViewIdNameAssign.EquipmentDataQueryEquipmentDailyDataQueryViewAttachRegion,
                               Wj2090Module.Services.ViewIdAssign.DataMiningViewId,
