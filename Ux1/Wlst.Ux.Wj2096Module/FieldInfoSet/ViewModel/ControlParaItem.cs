...
namespace Wlst.Ux.Wj2096Module.FieldInfoSet.ViewModel
{
    public class ControlParaItem : Wlst.Cr.Core.CoreServices.ObservableObject
    {
        ...
        public string BarCode
        {
            ...
            set
            {
                ...
                if (_barCode != null)
                {
                    ...
                    if (_barCode == "") _barCode = 0.ToString();
                    ...
                    {
                        _barCode = string.Format("{0:D15}", long.Parse(_barCode));
                        for (int i = 0; i < 3; i++)
                        {
                            _barCode = _barCode.Insert(4 * i + 4+i, " ");
                        }
                    }
        ...
        /// </summary>
        #region SimsCode
        private long _simsCodeId;
        public long SimsCodeId
        {
            get { return _simsCodeId; }
            set
            {
                if (_simsCodeId == value) return;
                _simsCodeId = value;
                RaisePropertyChanged(() => SimsCodeId);
        ...
        /// </summary>
        #region SimsCode
        private string _simsCode;
        public string SimsCode
        {
            get { return _simsCode; }
            set
            {
                if (_simsCode == value) return;
                _simsCode = value;
                RaisePropertyChanged(() => SimsCode);

                if (_simsCode != "")
                {
                    SimsCodeId = Convert.ToInt64(_simsCode);
                }
            }
        }
        #endregion
        ...
        /// </summary>
        #region UplinkReply
        private bool _uplinkReply;
        public bool UplinkReply
        {
            ...
            set
            {
                ...
                if (OnAttriChanged != null) OnAttriChanged(this, new AttriChangedArgs() { AttriIndex = 18 });
            }
        }
        #endregion
        ...
        public int UplinkTimer
        {
            ...
            set
            {
                ...
                if (OnAttriChanged != null) OnAttriChanged(this, new AttriChangedArgs() { AttriIndex = 19 });
            }
        }
        #endregion
        ...
        public ObservableCollection<NameValueInt> LoopNumItems
        {
            get 
            {
                if (_loopNumItems == null)
                {
                    ...
                    CurrentSelectLoopNumItem = _loopNumItems[0];
                }
        ...
        /// 设备型号
        /// </summary>
        #region CtrlTypeItems
        private ObservableCollection<NameValueInt> _ctrlTypeItems = null;
        public ObservableCollection<NameValueInt> CtrlTypeItems
        {
            get
            {
                if (_ctrlTypeItems == null)
                {
                    _ctrlTypeItems = new ObservableCollection<NameValueInt>();
                    if (SluSglInfoHold.CtrlTpyes.Count != 0)
                    {
                        foreach (var g in SluSglInfoHold.CtrlTpyes)
                        {
                            _ctrlTypeItems.Add(new NameValueInt() { Name = g.Value, Value = g.Key });
                        }
                    }
                    else
                    {
                        _ctrlTypeItems.Add(new NameValueInt() { Name = "盛同公司", Value = 1 });
                    }
                    CurrentCtrlTypeSelected = _ctrlTypeItems[0];
                }
                return _ctrlTypeItems;
            }
        }

        #endregion

        #region CurrentCtrlTypeSelected

        private NameValueInt _currentCtrlTypeSelected;
        public NameValueInt CurrentCtrlTypeSelected
        {
            get { return _currentCtrlTypeSelected; }
            set
            {
                if (_currentCtrlTypeSelected == value) return;
                _currentCtrlTypeSelected = value;
                RaisePropertyChanged(() => CurrentCtrlTypeSelected);

                if (OnAttriChanged != null) OnAttriChanged(this, new AttriChangedArgs() { AttriIndex = 20 });
            }
        }
        #endregion
        ...
        public ObservableCollection<NameValueInt> LoopRatePowerItems1
        {
            get
            {
                if (_loopRatePowerItems1 == null)
                {
                    ...
                    _loopRatePowerItems1.Add(new NameValueInt() { Name = "0-20", Value = 1 });
                    _loopRatePowerItems1.Add(new NameValueInt() { Name = "21-50", Value = 14 });
                    _loopRatePowerItems1.Add(new NameValueInt() { Name = "51-75", Value = 15 });
                    _loopRatePowerItems1.Add(new NameValueInt() { Name = "75-100", Value = 2 });
                    _loopRatePowerItems1.Add(new NameValueInt() { Name = "101-120", Value = 3 });
                    _loopRatePowerItems1.Add(new NameValueInt() { Name = "121-150", Value = 4 });
                    _loopRatePowerItems1.Add(new NameValueInt() { Name = "151-200", Value = 5 });
                    _loopRatePowerItems1.Add(new NameValueInt() { Name = "201-250", Value = 6 });
                    _loopRatePowerItems1.Add(new NameValueInt() { Name = "251-300", Value = 7 });
                    _loopRatePowerItems1.Add(new NameValueInt() { Name = "301-400", Value = 8 });
                    _loopRatePowerItems1.Add(new NameValueInt() { Name = "401-600", Value = 9 });
                    _loopRatePowerItems1.Add(new NameValueInt() { Name = "601-800", Value = 10 });
                    _loopRatePowerItems1.Add(new NameValueInt() { Name = "801-1000", Value = 11 });
                    _loopRatePowerItems1.Add(new NameValueInt() { Name = "1001-1500", Value = 12 });
                    _loopRatePowerItems1.Add(new NameValueInt() { Name = "1501-2000", Value = 13 });
        ...
        public ObservableCollection<NameValueInt> LoopRatePowerItems2
        {
            get
            {
                if (_loopRatePowerItems2 == null)
                {
                    ...
                    _loopRatePowerItems2.Add(new NameValueInt() { Name = "0-20", Value = 1 });
                 
                    _loopRatePowerItems2.Add(new NameValueInt() { Name = "21-50", Value = 14 });
                    _loopRatePowerItems2.Add(new NameValueInt() { Name = "51-75", Value = 15 });
                    _loopRatePowerItems2.Add(new NameValueInt() { Name = "75-100", Value = 2 });
                    _loopRatePowerItems2.Add(new NameValueInt() { Name = "101-120", Value = 3 });
                    _loopRatePowerItems2.Add(new NameValueInt() { Name = "121-150", Value = 4 });
                    _loopRatePowerItems2.Add(new NameValueInt() { Name = "151-200", Value = 5 });
                    _loopRatePowerItems2.Add(new NameValueInt() { Name = "201-250", Value = 6 });
                    _loopRatePowerItems2.Add(new NameValueInt() { Name = "251-300", Value = 7 });
                    _loopRatePowerItems2.Add(new NameValueInt() { Name = "301-400", Value = 8 });
                    _loopRatePowerItems2.Add(new NameValueInt() { Name = "401-600", Value = 9 });
                    _loopRatePowerItems2.Add(new NameValueInt() { Name = "601-800", Value = 10 });
                    _loopRatePowerItems2.Add(new NameValueInt() { Name = "801-1000", Value = 11 });
                    _loopRatePowerItems2.Add(new NameValueInt() { Name = "1001-1500", Value = 12 });
                    _loopRatePowerItems2.Add(new NameValueInt() { Name = "1501-2000", Value = 13 });
        ...
        public ObservableCollection<NameValueInt> LoopRatePowerItems3
        {
            get
            {
                if (_loopRatePowerItems3 == null)
                {
                    ...
                    _loopRatePowerItems3.Add(new NameValueInt() { Name = "0-20", Value = 1 });
       
                    _loopRatePowerItems3.Add(new NameValueInt() { Name = "21-50", Value = 14 });
                    _loopRatePowerItems3.Add(new NameValueInt() { Name = "51-75", Value = 15 });
                    _loopRatePowerItems3.Add(new NameValueInt() { Name = "75-100", Value = 2 });
                    _loopRatePowerItems3.Add(new NameValueInt() { Name = "101-120", Value = 3 });
                    _loopRatePowerItems3.Add(new NameValueInt() { Name = "121-150", Value = 4 });
                    _loopRatePowerItems3.Add(new NameValueInt() { Name = "151-200", Value = 5 });
                    _loopRatePowerItems3.Add(new NameValueInt() { Name = "201-250", Value = 6 });
                    _loopRatePowerItems3.Add(new NameValueInt() { Name = "251-300", Value = 7 });
                    _loopRatePowerItems3.Add(new NameValueInt() { Name = "301-400", Value = 8 });
                    _loopRatePowerItems3.Add(new NameValueInt() { Name = "401-600", Value = 9 });
                    _loopRatePowerItems3.Add(new NameValueInt() { Name = "601-800", Value = 10 });
                    _loopRatePowerItems3.Add(new NameValueInt() { Name = "801-1000", Value = 11 });
                    _loopRatePowerItems3.Add(new NameValueInt() { Name = "1001-1500", Value = 12 });
                    _loopRatePowerItems3.Add(new NameValueInt() { Name = "1501-2000", Value = 13 });
        ...
        public ObservableCollection<NameValueInt> LoopRatePowerItems4
        {
            get
            {
                if (_loopRatePowerItems4 == null)
                {
                    ...
                    _loopRatePowerItems4.Add(new NameValueInt() { Name = "0-20", Value = 1 });
                
                    _loopRatePowerItems4.Add(new NameValueInt() { Name = "21-50", Value = 14 });
                    _loopRatePowerItems4.Add(new NameValueInt() { Name = "51-75", Value = 15 });
                    _loopRatePowerItems4.Add(new NameValueInt() { Name = "75-100", Value = 2 });
                    _loopRatePowerItems4.Add(new NameValueInt() { Name = "101-120", Value = 3 });
                    _loopRatePowerItems4.Add(new NameValueInt() { Name = "121-150", Value = 4 });
                    _loopRatePowerItems4.Add(new NameValueInt() { Name = "151-200", Value = 5 });
                    _loopRatePowerItems4.Add(new NameValueInt() { Name = "201-250", Value = 6 });
                    _loopRatePowerItems4.Add(new NameValueInt() { Name = "251-300", Value = 7 });
                    _loopRatePowerItems4.Add(new NameValueInt() { Name = "301-400", Value = 8 });
                    _loopRatePowerItems4.Add(new NameValueInt() { Name = "401-600", Value = 9 });
                    _loopRatePowerItems4.Add(new NameValueInt() { Name = "601-800", Value = 10 });
                    _loopRatePowerItems4.Add(new NameValueInt() { Name = "801-1000", Value = 11 });
                    _loopRatePowerItems4.Add(new NameValueInt() { Name = "1001-1500", Value = 12 });
                    _loopRatePowerItems4.Add(new NameValueInt() { Name = "1501-2000", Value = 13 });
