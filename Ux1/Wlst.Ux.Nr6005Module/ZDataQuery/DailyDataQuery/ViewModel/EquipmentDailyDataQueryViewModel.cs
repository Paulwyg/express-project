...
namespace Wlst.Ux.Nr6005Module.ZDataQuery.DailyDataQuery.ViewModel
{
    ...
    public partial class EquipmentDailyDataQueryViewModel
    {
        ...
        public int PageIndex
        {
            ...
            set
            {
                if (value != _pageIndex)
                {
                    ...
                    //RequestHttpData(PageIndex,RtuId,DtStartTime.Ticks,DtEndTime.Ticks);
        ...
        private int _pagingRecordTotal;

        /// <summary>
        /// 总记录数
        /// </summary>
        public int PagingRecordTotal
        {
            get { return _pagingRecordTotal; }
            set
            {
                if (value != _pagingRecordTotal)
                {
                    _pagingRecordTotal = value;
                    this.RaisePropertyChanged(() => this.PagingRecordTotal);
        ...
        {
            get { return _pagingNum; }
            set
            {
                if (value != _pagingNum)
                {
                    _pagingNum = value;
                    this.RaisePropertyChanged(() => this.PagingNum);
