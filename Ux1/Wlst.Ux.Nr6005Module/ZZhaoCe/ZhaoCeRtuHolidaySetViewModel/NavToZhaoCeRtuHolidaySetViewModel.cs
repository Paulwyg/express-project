...
namespace Wlst.Ux.Nr6005Module.ZZhaoCe.ZhaoCeRtuHolidaySetViewModel
{
    ...
    public class NavToZhaoCeRtuHolidaySetViewModelId : MenuItemBase
    {
        ...
        {
            Id = Nr6005Module.Services.MenuIdAssgin.NavToZhaoCeRtuHolidaySetViewModelId;
            // Infrastructure.IdAssign.MenuIdAssign.NavToTmlInfoSetforWj3090Id;
            Text = "召测节假日设置";
            Tag = "召测节假日设置";
            Description = "召测节假日设置，ID 为" + Nr6005Module.Services.MenuIdAssgin.NavToZhaoCeRtuHolidaySetViewModelId;
            // Infrastructure.IdAssign.MenuIdAssign.NavToTmlInfoSetforWj3090Id;
            Tooltips = "召测节假日设置";
