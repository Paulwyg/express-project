...
namespace Wlst.Ux.Nr6005Module.ZZhaoCe.ZhaoCeRtuInfoViewModel
{
    ...
    public class NavToZhaoCeRtuInfoViewModel : MenuItemBase
    {
        ...
        {
            Id = Nr6005Module.Services.MenuIdAssgin.NavToZhaoCeRtuInfoViewModelId;
                // Infrastructure.IdAssign.MenuIdAssign.NavToTmlInfoSetforWj3090Id;
            Text = "召测终端参数";
            Tag = "召测终端参数";
            Description = "召测终端参数，ID 为" + Nr6005Module.Services.MenuIdAssgin.NavToZhaoCeRtuInfoViewModelId;
                // Infrastructure.IdAssign.MenuIdAssign.NavToTmlInfoSetforWj3090Id;
            Tooltips = "召测终端参数";
