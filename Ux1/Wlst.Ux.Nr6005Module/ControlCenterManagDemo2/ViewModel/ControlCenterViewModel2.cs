...
using Wlst.Ux.Nr6005Module.ControlCenterManagDemo2.Views;
using Wlst.client;
        ...
        private void ExCmdInMainWindow(string datax)
        {
            ...
            if (x == 9)
            {
                ...
                RegionManage.ShowViewByIdAttachRegionWithArgu(
                    Wlst.Ux.Nr6005Module.Services.ViewIdAssign.NavToBatchStopView, lstRtu,0);
                return;
            }
            if (x == 10)
            {
                ...
                RegionManage.ShowViewByIdAttachRegionWithArgu(
                    Wlst.Ux.Nr6005Module.Services.ViewIdAssign.NavToBatchStopView, lstRtu,1);
                return;
            }
