...
namespace Wlst.Ux.Nr6005Module.RtuLdlSet.ViewModels
{
    ...
    public partial class ItemOne
    {
        ...
        public void SetNewData(RtuNewDataInfo info, bool isjumpcan)
        {
        ...
        public void CalLdl()
        {
            ...
            try
            {
                ...
                {
                    if (f.TargetTest > 0.85 || f.TargetTest < 100) continue;
    ...
    public class ItemLoop : Wlst.Cr.Core.CoreServices.ObservableObject
    {
        ...
        public int TargetTestX
        {
            get
            {
                if (TargetTest * 100 > 2147483647 )
                {
                    return 2147483647;
                }
                else if ( TargetTest * 100 < -2147483648)
                {
                    return -2147483648;
                }
                else if (TargetTest * 100 <= 2147483647 && TargetTest * 100 > -2147483648)
                {
                    return Convert.ToInt32(TargetTest * 100);
                }
                else
                {
                    return 0;
