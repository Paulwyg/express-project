...
namespace Wlst.Ux.Wj6005Module.Jd601ControlAndData.ViewModel
{
    public class EsuDataOneItemViewModel : Wlst.Cr.Core.CoreServices.ObservableObject
    {
        ...
        public EsuDataOneItemViewModel(Jd601Data info)
        {
            Id = info.Id;
            RtuId = info.RtuId;
            EsuBootTime = "" + (info.EsuBootTime/60) + ":" + (info.EsuBootTime%60);
            EsuControlState = "未知";
            ...
            EsuOutputCurrentpA = info.EsuOutputCurrentpA + " Kwh";
            EsuOutputCurrentpB = info.EsuOutputCurrentpB + " Kwh";
            EsuOutputCurrentpC = info.EsuOutputCurrentpC + " Kwh";
            ...
            EsuRunTime = "" + (info.EsuRunTime/60) + ":" + (info.EsuRunTime%60);
            EsuTargetValue = info.EsuTargetValue + " V";
