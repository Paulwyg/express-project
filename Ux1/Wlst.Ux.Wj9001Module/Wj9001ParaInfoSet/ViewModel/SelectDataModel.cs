...
namespace Wlst.Ux.Wj9001Module.Wj9001ParaInfoSet.ViewModel
{
    public class SelectDataModel: Cr.Core.CoreServices.ObservableObject
    {
        ...
        /// 回路1检测标识 故障参数
        /// </summary>
        private int _flagDetection; //回路1检测标识
        public int FlagDetection
        {
        ...
        /// 回路1报警标识  故障数据
        /// </summary>
        private int _flagAlarm; //回路1报警标识
        public int FlagAlarm
        {
        ...
        public SelectDataModel(LduLineData item)
        {
            ...
            if (dh != null && dh.RtuFid != 0) AttachRtuId = dh.RtuFid;
