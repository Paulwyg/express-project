...
namespace Wlst.Ux.Wj1080Module.Wj1080InfoSet
{
   ...
   public class NavToWj1080DataStatistics : MenuItemBase
   {
       public NavToWj1080DataStatistics()
       {
           Id = Wj1080Module.Services.MenuIdAssgin.NavToWj1080DataStatisticsId;
           // Infrastructure.IdAssign.MenuIdAssign.NavToWj1080TmlInfoSetId;
           Text  = "数据统计";
           Tag = "WJ1080终端数据统计";
           this.Classic = "右键菜单-WJ1080-专有";
           Description = "WJ1080终端数据统计，ID 为" + Wj1080Module.Services.MenuIdAssgin.NavToWj1080DataStatisticsId;
           //Infrastructure.IdAssign.MenuIdAssign.NavToWj1080TmlInfoSetId;
           Tooltips = "WJ1080终端数据统计";
           base.IsEnabled = true;
       ...
       protected void Ex()
       {
           ...
           List<int> list = new List<int>(){rtuId ,SelectIndex};
            this.ExNavWithArgs(
               ...
               Wj1080Module.Services.ViewIdAssign.Wj1080TmlInfoSetViewId, list
                            );
       }
   }
}
