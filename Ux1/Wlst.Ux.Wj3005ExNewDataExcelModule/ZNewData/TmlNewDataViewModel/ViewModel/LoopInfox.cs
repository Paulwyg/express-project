...
namespace Wlst.Ux.Wj3005ExNewDataExcelModule.ZNewData.TmlNewDataViewModel.ViewModel
{
   ...
   public class LoopInfox : ObservableObject
   {
       public LoopInfox(int loopId, string loopName, string v, string a, string power, string brightrate, string powerfactor, string  isAttachShow, string attachShowInfo, string attachShowInfoName, string backgnd, string backgroundAttach,string refa, string upper,string lower,string ratio,string onlinerate,string isred,int isShieldLoop)
       {
           this.LoopId = loopId;
           this.A = a;
           this.Power = power;
           ...
           this.ShieldLoopMark = isShieldLoop!=0 ? "屏蔽" : "正常";
           Backgroundx = backgnd;
       ...
       public string ShieldLoopMark
       {
           ...
           set
           {
               if (value != _shieldLoopMark)
               {
                   ...
                   this.RaisePropertyChanged(() => this.ShieldLoopMark);
               }
           }
       }
