...
namespace Wlst.Ux.WJ3005Module.ZOrders.OpenCloseLight
{
   public  class OrderServer
   {
       ...
       public static void OpenLight(int rtuId, int loop)
       {
           ...
           //SndOrderServer.OrderSnd(WJ3005Module.Services.EventIdAssign.OpenLight, arg, data, gid);
       ...
       public static void CloseLight(int rtuId, int loop, bool ifLightIsAlwaysOn)
       {
           ...
           //SndOrderServer.OrderSnd(WJ3005Module.Services.EventIdAssign.CloseLight, arg, data, gid);
