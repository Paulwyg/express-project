...
namespace Wlst.Ux.WJ3005Module.ZOrders.AsynTime
{
    ...
    public class RtuAsynTime : MenuItemBase
    {
        ...
        private void Ex()
        {
            ...
            //SndOrderServer.OrderSnd(WJ3005Module.Services.EventIdAssign.RtuAsynTimeId, arg, null, 0);
    ...
    public class RtuAsynTimeSingle : MenuItemBase
    {
        ...
        private void Ex()
        {
           ...
           // SndOrderServer.OrderSnd(WJ3005Module.Services.EventIdAssign.RtuAsynTimeId, lst, null, 0);
