...
namespace Wlst.Ux.WJ3005Module.RtuLdlSet
{
    //public class NavTo
    //{
    ...
    public class NavTo : MenuItemBase
    {
        public NavTo()
        {
            Id = Wlst.Ux.WJ3005Module.Services.MenuIdAssgin.NavToLdlId;
            // Infrastructure.IdAssign.MenuIdAssign.NavToSndWeekTimeQueryViewId;
            Text = "终端亮灯率设置";
            Tag = "终端亮灯率设置";
            this.Classic = "主菜单";
            Description = "终端亮灯率设置，ID 为" + Wlst.Ux.WJ3005Module.Services.MenuIdAssgin.NavToLdlId;
            // Infrastructure.IdAssign.MenuIdAssign.NavToSndWeekTimeQueryViewId;
            Tooltips = "终端亮灯率设置";
            base.IsEnabled = true;
        ...
        protected void Ex()
        {
            ...
            this.ExNavWithArgs(
                               WJ3005Module.Services.ViewIdAssign.NavToLdlViewId,
                               0);
