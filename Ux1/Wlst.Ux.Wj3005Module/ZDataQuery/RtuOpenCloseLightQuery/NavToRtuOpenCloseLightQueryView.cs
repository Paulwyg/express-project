...
namespace Wlst.Ux.WJ3005Module.ZDataQuery.RtuOpenCloseLightQuery
{
    ...
    public class NavToRtuOpenCloseLightQueryView : MenuItemBase
    {
        ...
        {
            Id = WJ3005Module.Services.MenuIdAssgin.NavToRtuOpenCloseLightQueryViewId ;
                // Infrastructure.IdAssign.MenuIdAssign.NavToSndWeekTimeQueryViewId;
            Text = "时间统计";
            Tag = "开关灯时间统计";
            this.Classic = "主菜单";
            Description = "开关灯时间统计，ID 为" + WJ3005Module.Services.MenuIdAssgin.NavToRtuOpenCloseLightQueryViewId;
                // Infrastructure.IdAssign.MenuIdAssign.NavToSndWeekTimeQueryViewId;
            Tooltips = "开关灯时间统计";
            base.IsEnabled = true;
        ...
        protected void Ex()
        {
            ...
            this.ExNavWithArgs(
                               WJ3005Module.Services.ViewIdAssign.RtuOpenCloseLightQueryViewId,
                               0);
