...
namespace Wlst.Ux.WJ3005Module.ZDataQuery.RtuOpenCloseLightOneDayReportQuery
{
    ...
    public class NavToRtuOpenCloseLightOneDayReportQuery : MenuItemBase
    {
        ...
        {
            Id = WJ3005Module.Services.MenuIdAssgin.NavToRtuOpenCloseLightOneDayReportQueryId;
            // Infrastructure.IdAssign.MenuIdAssign.NavToEquipmentDailyDataQueryViewId;
            Text = "开关灯结果查询";
            Tag = "开关灯结果查询";
            this.Classic = "主菜单";
            Description = "开关灯结果查询，ID 为" +
                          WJ3005Module.Services.MenuIdAssgin.NavToRtuOpenCloseLightOneDayReportQueryId;
            // Infrastructure.IdAssign.MenuIdAssign.NavToEquipmentDailyDataQueryViewId;
            Tooltips = "开关灯结果查询";
            base.IsEnabled = true;
        ...
        protected void Ex()
        {
            ...
            this.ExNavWithArgs(
                               ...
                               WJ3005Module.Services.ViewIdAssign.RtuOpenCloseLightSuccQueryViewId,
