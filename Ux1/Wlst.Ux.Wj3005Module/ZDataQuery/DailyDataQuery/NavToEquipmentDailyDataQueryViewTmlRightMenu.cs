...
namespace Wlst.Ux.WJ3005Module.ZDataQuery.DailyDataQuery
{
    ...
    public class NavToEquipmentDailyDataQueryViewTmlRightMenu : MenuItemBase
    {
        ...
        {
            Id = WJ3005Module.Services.MenuIdAssgin.NavToEquipmentDailyDataQueryViewTmlRightMenuId;// Infrastructure.IdAssign.MenuIdAssign.NavToEquipmentDailyDataQueryViewId;
            Text = "终端数据";
            Tag = "数据查询";
            this.Classic = "终端右键菜单";
            Description = "数据查询，ID 为" + WJ3005Module.Services.MenuIdAssgin.NavToEquipmentDailyDataQueryViewTmlRightMenuId;// Infrastructure.IdAssign.MenuIdAssign.NavToEquipmentDailyDataQueryViewId;
            Tooltips = "数据查询";
            base.IsEnabled = true;
        ...
        protected void Ex()
        {
            ...
            this.ExNavWithArgs(
                ...
                WJ3005Module.Services.ViewIdAssign.EquipmentDailyDataQueryViewId,
