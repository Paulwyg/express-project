...
namespace Wlst.Ux.WJ3005Module.ZDataQuery.SndWeekTimeQuery
{
    ...
    public class NavToSndWeekTimeQueryViewTmlRightMenu : MenuItemBase
    {
        ...
        {
            Id = WJ3005Module.Services.MenuIdAssgin.NavToSndWeekTimeQueryViewTmlRightMenuId;
            // Infrastructure.IdAssign.MenuIdAssign.NavToSndWeekTimeQueryViewId;
            Text = "周设置记录";
            Tag = "周设置记录";
            this.Classic = "终端右键菜单";
            Description = "周设置记录，ID 为" +
                          WJ3005Module.Services.MenuIdAssgin.NavToSndWeekTimeQueryViewTmlRightMenuId;
            // Infrastructure.IdAssign.MenuIdAssign.NavToSndWeekTimeQueryViewId;
            Tooltips = "周设置记录";
            base.IsEnabled = true;
