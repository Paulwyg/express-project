...
namespace Wlst.Ux.WJ3005Module.LnEmergencyOperationCenter.Converters
{
    ...
    public class SelectionAnsConverter : IValueConverter
    {
        ...
        private static BitmapSource _noNeedBitmap;

        private static BitmapSource NoNeedBitmap
        {
            get
            {
                if (_noNeedBitmap == null)
                {
                    _noNeedBitmap = ImageSourceHelper.MySelf.GetBitmapSourceById(10000002);
                }
                return _noNeedBitmap;
            }
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            try
            {
                ...
                else if (param == EnumSelectionTestAns.NoNeed) return NoNeedBitmap;
