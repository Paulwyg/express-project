...
namespace Wlst.Ux.WJ3005Module.Wj3005TmlInfoSetViewModel
{
    ...
    public class NavToWj3005TmlInfoSet : MenuItemBase
    {
        ...
        {
            Id = WJ3005Module.Services.MenuIdAssgin.NavToWj3005TmlInfoSetId;// Infrastructure.IdAssign.MenuIdAssign.NavToWj3005TmlInfoSetId;
            Text = "终端参数设置";
            Tag = "终端参数设置";
            this.Classic = "右键菜单-3005-3009";
            Description = "照明终端参数设置，ID 为" + WJ3005Module.Services.MenuIdAssgin.NavToWj3005TmlInfoSetId;// Infrastructure.IdAssign.MenuIdAssign.NavToWj3005TmlInfoSetId;
            Tooltips = "设置当前终端终端参数";
        ...
        protected void Ex()
        {
            ...
            if (rtuId < 1)
                return;
            this.ExNavWithArgs(
                WJ3005Module .Services .ViewIdAssign .Wj3005TmlInfoSetViewId ,
                rtuId);
        }
    }
}