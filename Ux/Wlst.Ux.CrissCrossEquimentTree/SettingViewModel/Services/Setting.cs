...
namespace Wlst.Ux.CrissCrossEquipemntTree.SettingViewModel.Services
{
    ...
    public class Setting
    {
        ...
        public bool IsShowSingleTreeOnTabOrNot
        {
            set
            {
                if (UxCrissCrossTreeSetting.IsShowSingleTreeOnTab == value) return;
                UxCrissCrossTreeSetting.IsShowSingleTreeOnTab = value;
                RegionManage.ShowViewByIdAttachRegion(
                    CrissCrossEquipemntTree.Services.ViewIdAssign.GrpSingleTabShowViewId,

                    UxCrissCrossTreeSetting.IsShowSingleTreeOnTab);
    ...
    UxCrissCrossTreeSetting.IsShowSingleTreeOnTab);
            ...
            get { return UxCrissCrossTreeSetting.IsShowSingleTreeOnTab; }
        }
        ...
        public bool IsShowMulTreeOnTabOrNot
        {
            set
            {
                ...
                //    CrissCrossEquipemntTree.Services.ViewIdAssign.GrpMulityTabShowViewId,
        ...
        {
            set { UxCrissCrossTreeSetting.IsRutsNotShowNullK = value; }
            get { return UxCrissCrossTreeSetting.IsRutsNotShowNullK; }
        }
        /// <summary>
        ...
        {
            set { UxCrissCrossTreeSetting.IsShowRapidOp = value; }
            get { return UxCrissCrossTreeSetting.IsShowRapidOp; }
        }
        /// <summary>
        /// 快速查询显示上限
        /// </summary>
        ...
        {
            set { UxCrissCrossTreeSetting.SearchLimit = value; }
            get { return UxCrissCrossTreeSetting.SearchLimit; }
        }
    }
}
