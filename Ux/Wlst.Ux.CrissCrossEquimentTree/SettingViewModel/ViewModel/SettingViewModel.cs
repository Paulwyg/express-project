...
namespace Wlst.Ux.CrissCrossEquipemntTree.SettingViewModel.ViewModel
{
    ...
    public class SettingViewModel : ObservableObject, IISettingViewModel
    {
        ...
        private void Ex()
        {
            ...
            dic.Add(1, IsShowSingleTreeOnTab ? "1" : "0");
            desc.Add(1, "是否呈现交叉分组");
            ...
            SettingExtend.Myself.UpdateSetting(this.IsShowSingleTreeOnTab);
        ...
        private bool CanEx()
        {
            ...
            //    this.IsShowSingleTreeOnTab == UxCrissCrossTreeSetting.IsShowSingleTreeOnTab &&
            ...
            //     this.IsRutsNotShowNullK == UxCrissCrossTreeSetting.IsRutsNotShowNullK &&
            //     this.IsShowRapidOp == UxCrissCrossTreeSetting.IsShowRapidOp &&
            //    this .TreeSortBy ==UxTreeSetting .TreeSortBy &&
            //    this.SearchLimit== UxCrissCrossTreeSetting.SearchLimit
        ...
        public void NavOnLoad(params object[] parsObjects)
        {
            ...
            this.IsShowSingleTreeOnTab = Wlst.Cr.CoreOne.Services.OptionXmlSvr.GetOptionBool(4002, 1, false);
            UxCrissCrossTreeSetting.IsShowSingleTreeOnTab = Wlst.Cr.CoreOne.Services.OptionXmlSvr.GetOptionBool(4002, 1, false);
