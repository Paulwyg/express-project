...
{
    [Export(typeof(IIRegionTree))]
    [PartCreationPolicy(CreationPolicy.Shared)]
    public partial class TreeRegionViewModel : ObservableObject, IIRegionTree
    {
        ...
        public static TreeRegionViewModel MySelf;
        public TreeRegionViewModel()
        {
        ...
        private void LoadNodeOther()
        {
            ...
            if (userProperty.D == true)
            {
                ...
                if (IsLoadOnlyOneArea)
                {
                    ...
                    this.ChildTreeItems.Add(new TreeNodeItemRegionGroupViewModel(null, AreaId, 0, TypeOfTabTreeNode.IsAll));
                    ...
                    if (sp.Count > 0)
                        ...
                        this.ChildTreeItems.Add(new TreeNodeItemRegionGroupViewModel(null, AreaId, 0, "特殊终端",
                ...
                else
                {
                    ...
                    foreach (var f in areaIndex)//Wlst.Sr.EquipmentInfoHolding.Services.AreaInfoHold.MySlef.AreaInfo.Keys
                    {
                        ...
                        if (rtuLst.Count == 0) continue;
                        this.ChildTreeItems.Add(new TreeNodeItemRegionGroupViewModel(null, f, 0,
                                                                                     TypeOfTabTreeNode.IsArea));
                    }
                }
            }
            else
            {
                ...
                else
                {
                    ...
                    foreach (var f in areaIndex)//areaLst
                    {
                        ...
                        if (rtuLst.Count == 0) continue;
                        this.ChildTreeItems.Add(new TreeNodeItemRegionGroupViewModel(null, f, 0, TypeOfTabTreeNode.IsArea));
                    }
                }
            }
            foreach (var f in ChildTreeItems)
        ...
        event EventHandler<NodeSelectedArgs> IIRegionTree. OnSelectedNodeByCode
        {
    ...
    //search
    public partial class TreeRegionViewModel
    {
        ...
        private void ExCmdControl()
        {
            ...
            //todo test lvf 2019年5月14日10:25:42
