...
namespace Wlst.Ux.EquipemntLightFault.EquipmentFaultRecordQueryLevelLowViewModel
{
    ...
    public class NavToEquipmentFaultRecordQueryViewTmlRightMenuNormal : MenuItemBase
    {
        public NavToEquipmentFaultRecordQueryViewTmlRightMenuNormal()
        {
            Id = EquipemntLightFault.Services.MenuIdAssgin.NavToEquipmentFaultRecordQueryViewTmlRightLevelNormalMenuId;
            //Infrastructure.IdAssign.MenuIdAssign.NavToEquipmentFaultRecordQueryViewId;
            Text = "普通故障查询";
            Tag = "普通故障查询";
            Classic = "终端右键菜单";
            Description = "终端普通故障查询，ID 为" + EquipemntLightFault.Services.MenuIdAssgin.NavToEquipmentFaultRecordQueryViewTmlRightLevelNormalMenuId;
            //Infrastructure.IdAssign.MenuIdAssign.NavToEquipmentFaultRecordQueryViewId;
            Tooltips = "普通故障查询";
            IsEnabled = true;
            IsCheckable = false;
