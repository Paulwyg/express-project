...
namespace Wlst.Ux.EquipemntLightFault.EquipmentFaultRecordQueryLevelLowViewModel.Views
{
    /// <summary>
    /// EquipmentFaultRecordQueryView.xaml 的交互逻辑 EquipmentDataQueryEquipmentFaultRecordQueryView
    /// </summary>
    //[ViewExport( EquipemntLightFault.Services.ViewIdAssign.EquipmentFaultRecordQueryLevelLowViewId)]
    //[PartCreationPolicy(CreationPolicy.Shared)]
    public partial class EquipmentFaultRecordQueryView  
    {
        private ViewModel .EquipmentFaultRecordQueryViewModel dtcontext=null ;
        public EquipmentFaultRecordQueryView()
        {
            ...
            dtcontext = new ViewModel.EquipmentFaultRecordQueryViewModel();
            this.DataContext = dtcontext;
        }

        public const string XmlConfigName = "DisplayIndex\\Wlst.Ux.EquipemntLightFault.EquipmentFaultRecordQueryLevelLowViewModel.Views.EquipmentFaultRecordQueryView";
        ...
        {
            dtcontext.Level = lev;// (lev);
            
        }

        public void SetSelectRtu(int rtu)
        {
            dtcontext.rtuId = rtu;
        }
        ...
        {
            if (dtcontext != null)
                dtcontext.CounterLableDoubleClick += 1;
        }
        ...
        private void rgv_MouseDoubleClick(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            ...
            if (dtcontext != null) dtcontext.OnRequestServerData(item);
        ...
        private void DatePicker_MouseDoubleClick(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
