...
namespace Wlst.Ux.EquipemntLightFault.EquipmentFaultRecordQueryLevelLowViewModel
{
    ...
    public class NavToEquipmentFaultRecordQueryViewTmlRightMenuLow : MenuItemBase
    {
        public NavToEquipmentFaultRecordQueryViewTmlRightMenuLow()
        {
            Id = EquipemntLightFault.Services.MenuIdAssgin.NavToEquipmentFaultRecordQueryViewTmlRightLevelLowMenuId;
            //Infrastructure.IdAssign.MenuIdAssign.NavToEquipmentFaultRecordQueryViewId;
            Text = "忽略故障查询";
            Tag = "忽略终端故障查询";
            Classic = "终端右键菜单";
            Description = "忽略终端故障查询，ID 为" + EquipemntLightFault.Services.MenuIdAssgin.NavToEquipmentFaultRecordQueryViewTmlRightLevelLowMenuId;
            //Infrastructure.IdAssign.MenuIdAssign.NavToEquipmentFaultRecordQueryViewId;
            Tooltips = "忽略终端故障查询";
            IsEnabled = true;
            IsCheckable = false;
        ...
        public static void InitWin()
        {
            if (FalutQueryWindow == null)
            {
                ...
                FalutQueryWindow.Title = "忽略故障查询";
                FalutQueryWindow.TitleCetc = "忽略故障查询";
            }
