...
namespace Wlst.Ux.EquipemntLightFault.EquipmentFaultRecordQueryLevelLowViewModel
{
    ...
    public class NavToEquipmentFaultRecordQueryViewLow : MenuItemBase
    {
        public NavToEquipmentFaultRecordQueryViewLow()
        {
            Id = EquipemntLightFault.Services.MenuIdAssgin.NavToEquipmentFaultRecordQueryLevelLowViewId;
            //Infrastructure.IdAssign.MenuIdAssign.NavToEquipmentFaultRecordQueryViewId;
            Text = "忽略故障查询";
            Tag = "忽略故障查询";
            Classic = "主菜单";
            Description = "终端忽略故障查询，ID 为" + EquipemntLightFault.Services.MenuIdAssgin.NavToEquipmentFaultRecordQueryLevelLowViewId;
            //Infrastructure.IdAssign.MenuIdAssign.NavToEquipmentFaultRecordQueryViewId;
            Tooltips = "忽略故障查询";
            IsEnabled = true;
            IsCheckable = false;
