...
namespace Wlst.Ux.EquipemntLightFault.EquipmentFaultRecordQuerySZViewModel
{
    ...
    public class NavToEquipmentFaultRecordQueryViewTmlRightMenu : MenuItemBase
    {
        ...
        {
            Id = EquipemntLightFault.Services.MenuIdAssgin.NavToEquipmentFaultRecordQueryViewTmlRightSzMenuId;
            //Infrastructure.IdAssign.MenuIdAssign.NavToEquipmentFaultRecordQueryViewId;
            Text = "故障查询";
            Tag = "终端故障查询";
            Classic = "终端右键菜单";
            Description = "终端故障查询，ID 为" + EquipemntLightFault.Services.MenuIdAssgin.NavToEquipmentFaultRecordQueryViewTmlRightSzMenuId;
            //Infrastructure.IdAssign.MenuIdAssign.NavToEquipmentFaultRecordQueryViewId;
            Tooltips = "终端故障查询";
            IsEnabled = true;
            IsCheckable = false;
