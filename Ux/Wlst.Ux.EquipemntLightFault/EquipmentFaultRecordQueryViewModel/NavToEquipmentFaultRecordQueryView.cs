...
namespace Wlst.Ux.EquipemntLightFault.EquipmentFaultRecordQueryViewModel
{
    ...
    public class NavToEquipmentFaultRecordQueryView : MenuItemBase
    {
        ...
        {
            Id = EquipemntLightFault.Services.MenuIdAssgin.NavToEquipmentFaultRecordQueryViewId;
            //Infrastructure.IdAssign.MenuIdAssign.NavToEquipmentFaultRecordQueryViewId;
            Text = "故障查询";
            Tag = "故障查询";
            Classic = "主菜单";
            Description = "终端故障查询，ID 为" + EquipemntLightFault.Services.MenuIdAssgin.NavToEquipmentFaultRecordQueryViewId;
            //Infrastructure.IdAssign.MenuIdAssign.NavToEquipmentFaultRecordQueryViewId;
            Tooltips = "故障查询";
            IsEnabled = true;
            IsCheckable = false;
