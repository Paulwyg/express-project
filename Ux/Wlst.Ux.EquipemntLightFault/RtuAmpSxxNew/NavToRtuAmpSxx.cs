...
namespace Wlst.Ux.EquipemntLightFault.EquipmentFaultDefineSettingViewModel.RtuAmpSxxNew
{
    [Export(typeof(IIMenuItem))]
    [PartCreationPolicy(CreationPolicy.Shared)]
    public class NavToRtuAmpSxxNew : MenuItemBase
    {
        ...
        public NavToRtuAmpSxxNew()
            {
                Id = EquipemntLightFault.Services.MenuIdAssgin.NavToRtuAmpSxxViewNewId;
                ...
                Description = "设置电流上下限，设置电流上下限报警的对比值，ID 为" +
                            EquipemntLightFault.Services.MenuIdAssgin.NavToRtuAmpSxxViewNewId;
                //Infrastructure.IdAssign.MenuIdAssign.NavToTimeTableBandingViewId;
            ...
            protected void Ex()
            {
                this.ExNavWithArgs(
                    ...
                    EquipemntLightFault.Services.ViewIdAssign.RtuAmpSxxViewNewId,
                                   "");
