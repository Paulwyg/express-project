...
namespace Wlst.Ux.LhEquipemntTree
{
    [ModuleExport(typeof(UxLhEquipemntTree), DependsOnModuleNames = new string[] { "SrEquipmentInfoHolding" })]
    public class UxLhEquipemntTree : IModule
    {
        #region IModule 成员
