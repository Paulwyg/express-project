...
namespace Wlst.Ux.LhEquipemntTree.GrpSingleTabShowViewModel.ViewModels
{
    /// <summary>
    /// 提供终端树节点基本结构
        ...
        public override void AddChild()
        {
            ...
            if (NodeType == TypeOfTabTreeNode.IsArea)
            {
                ...
                foreach (var f in grp)
                {
                    ...
                    this.ChildTreeItems.Add(new TreeNodeItemSingleGroupViewModel(this, f.AreaId, f.GroupId,
