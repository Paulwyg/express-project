...
namespace Wlst.Ux.LhEquipemntTree.SettingViewModel.Services
{
    /// <summary>
    /// 本模块的设置信息
    /// </summary>
    public class Setting
    {
        ...
        public bool IsShowSingleTreeOnTabOrNot
        {
            set
            {
                if (UxLhTreeSetting.IsShowSingleTreeOnTab == value) return;
                UxLhTreeSetting.IsShowSingleTreeOnTab = value;
                RegionManage.ShowViewByIdAttachRegion(
                    LhEquipemntTree.Services.ViewIdAssign.GrpSingleTabShowViewId,

                    UxLhTreeSetting.IsShowSingleTreeOnTab);

                //CETC50_Core .UtilityFunction .SQLiteHelper.ExecuteNonQuery( )
            }
            get { return UxLhTreeSetting.IsShowSingleTreeOnTab; }
        }
        ...
        public bool IsShowMulTreeOnTabOrNot
        {
            set
            {
                ...
                //    LhEquipemntTree.Services.ViewIdAssign.GrpMulityTabShowViewId,
        ...
        {
            set { UxLhTreeSetting.IsRutsNotShowNullK = value; }
            get { return UxLhTreeSetting.IsRutsNotShowNullK; }
        }
        /// <summary>
        ...
        {
            set { UxLhTreeSetting.IsShowRapidOp = value; }
            get { return UxLhTreeSetting.IsShowRapidOp; }
        }
        /// <summary>
        /// 快速查询显示上限
        /// </summary>
        ...
        {
            set { UxLhTreeSetting.SearchLimit = value; }
            get { return UxLhTreeSetting.SearchLimit; }
        }
    }
}
