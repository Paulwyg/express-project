...
namespace Wlst.Ux.MapGisLocalSP.Services
{
    ...
    public class MapEditMenu : MenuItemBase
    {
        public MapEditMenu()
        {
            Id = Wlst.Ux.MapGisLocalSP.Services.MenuIdAssign.MapEditId;// Infrastructure.IdAssign.MenuIdAssign.NavToWj3005TmlInfoSetId;
            Text = "地图编辑";
            Tag = "地图编辑";
            this.Classic = "地图编辑";
