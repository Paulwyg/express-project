...
using Wlst.Sr.EquipemntLightFault.Interfaces;


namespace Wlst.Ux.EquipemntLightFault.UserIndividuationFaultSettingViewModel.ViewModel
{
    public class UserIndividuationFaultViewModel : ObservableObject 
    {
        ...
        public UserIndividuationFaultViewModel(Wlst.client.UserSelfDefineFalutAlarm .UserselfDefineFalutAlarmItem  tmlFaultType)
        {
