...
namespace Elysium.ThemesSet.ButtonSet
{
    ...
    /// </summary>
    [PublicAPI]
    public static class ButtonAttriXaml
    {
        /// <summary>
        /// 按钮样式存放目录文件名称
        /// </summary>
        private const string ButtonSetXmlFileName = "ButtonXaml";
        ...
        public static double CornerRadiusValue //= new Thickness(1d);
        {
            get
            {
                if (Info.ContainsKey("CornerRadiusValue"))
                {
                    try
                    {
                        var convertFromString = Double.Parse(Info["CornerRadiusValue"]);
            ...
            set
            {
                try
                {
                    if (Info.ContainsKey("CornerRadiusValue")) Info["CornerRadiusValue"] = value.ToString();
                    else Info.Add("CornerRadiusValue", value.ToString());
                }
                catch (Exception ex)
                {
                }
        ...
        [PublicAPI] public static readonly DependencyProperty BorderThicknessProperty =
            DependencyProperty.RegisterAttached("BorderThickness", typeof (Thickness), typeof (ButtonAttriXaml),
        ...
        public static readonly DependencyProperty CornerRadiusValueProperty =
            DependencyProperty.RegisterAttached("CornerRadiusValue", typeof(double), typeof(ButtonAttriXaml),
                                                new FrameworkPropertyMetadata(CornerRadiusValue,
                                                                              FrameworkPropertyMetadataOptions.
                                                                                  AffectsArrange |
                                                                              FrameworkPropertyMetadataOptions.Inherits,
                                                                              null));
        ...
        [PublicAPI]
        public static void SetCornerRadiusValue([NotNull] DependencyObject obj, double value)
        {
            ValidationHelper.NotNull(obj, "obj");
            obj.SetValue(CornerRadiusValueProperty, value);
        }
        ...
        [PublicAPI] public static DependencyProperty NormalBackgrounBrushProperty =
            DependencyProperty.RegisterAttached("NormalBackgrounBrush", typeof (SolidColorBrush), typeof (ButtonAttriXaml),
        ...
        [PublicAPI] public static DependencyProperty NormalBorderBrushProperty =
            DependencyProperty.RegisterAttached("NormalBorderBrush", typeof (SolidColorBrush), typeof (ButtonAttriXaml),
        ...
        [PublicAPI] public static DependencyProperty NormalForegroundBrushProperty =
            DependencyProperty.RegisterAttached("NormalForegroundBrush", typeof (SolidColorBrush), typeof (ButtonAttriXaml),
        ...
        [PublicAPI] public static DependencyProperty MouseOverBackgroundBrushProperty =
            DependencyProperty.RegisterAttached("MouseOverBackgroundBrush", typeof (SolidColorBrush), typeof (ButtonAttriXaml),
        ...
        [PublicAPI] public static DependencyProperty MouseOverForegroundBrushProperty =
            DependencyProperty.RegisterAttached("MouseOverForegroundBrush", typeof (SolidColorBrush), typeof (ButtonAttriXaml),
        ...
        [PublicAPI] public static DependencyProperty MouseOverBorderBrushProperty =
            DependencyProperty.RegisterAttached("MouseOverBorderBrush", typeof (SolidColorBrush), typeof (ButtonAttriXaml),
        ...
        [PublicAPI] public static DependencyProperty PressedBorderBrushProperty =
            DependencyProperty.RegisterAttached("PressedBorderBrush", typeof (SolidColorBrush), typeof (ButtonAttriXaml),
        ...
        [PublicAPI] public static DependencyProperty PressedBackgroundBrushProperty =
            DependencyProperty.RegisterAttached("PressedBackgroundBrush", typeof (SolidColorBrush), typeof (ButtonAttriXaml),
        ...
        [PublicAPI] public static DependencyProperty PressedForegroundBrushProperty =
            DependencyProperty.RegisterAttached("PressedForegroundBrush", typeof (SolidColorBrush), typeof (ButtonAttriXaml),
        ...
        [PublicAPI] public static DependencyProperty DisableForegroundBrushProperty =
            DependencyProperty.RegisterAttached("DisableForegroundBrush", typeof (SolidColorBrush), typeof (ButtonAttriXaml),
        ...
        [PublicAPI] public static DependencyProperty DisableBackgroundBrushProperty =
            DependencyProperty.RegisterAttached("DisableBackgroundBrush", typeof (SolidColorBrush), typeof (ButtonAttriXaml),
        ...
        [PublicAPI] public static DependencyProperty DisableBorderBrushProperty =
            DependencyProperty.RegisterAttached("DisableBorderBrush", typeof (SolidColorBrush), typeof (ButtonAttriXaml),
