...
namespace Elysium.ThemesSet.ComboBoxListBoxSet
{
    ...
    /// </summary>
    [PublicAPI]
    public static class ComboBoxListBoxAttriXaml
    {
        /// <summary>
        /// 按钮样式存放目录文件名称
        /// </summary>
        private const string ButtonSetXmlFileName = "ComboBoxListBoxAttriXaml";
        ...
        public static Thickness InnerBorderThickness //= new Thickness(1d);
        {
            get
            {
                if (Info.ContainsKey("InnerBorderThickness"))
                {
                    try
                    {
                        var convertFromString = Double.Parse(Info["InnerBorderThickness"]);
                        return new Thickness(convertFromString);
                    }
                    catch (Exception ex)
                    {
            ...
            set
            {
                try
                {
                    if (Info.ContainsKey("InnerBorderThickness")) Info["InnerBorderThickness"] = value.Left.ToString();
                    else Info.Add("InnerBorderThickness", value.Left.ToString());
                }
                catch (Exception ex)
                {
                }
        ...
        [PublicAPI] public static readonly DependencyProperty BorderThicknessProperty =
            DependencyProperty.RegisterAttached("BorderThickness", typeof (Thickness), typeof (ComboBoxListBoxAttriXaml),
        ...
        public static readonly DependencyProperty InnerBorderThicknessProperty =
            DependencyProperty.RegisterAttached("InnerBorderThickness", typeof(Thickness), typeof(ComboBoxListBoxAttriXaml),
                                    new FrameworkPropertyMetadata(InnerBorderThickness,
                                                                  FrameworkPropertyMetadataOptions.
                                                                      AffectsArrange |
                                                                  FrameworkPropertyMetadataOptions.Inherits,
                                                                  null, ThicknessUtil.CoerceNonNegative));
        ...
        [PublicAPI]
        [SuppressMessage("Microsoft.Contracts", "Ensures", Justification = "Can't be proven.")]
        public static Thickness GetInnerBorderThickness([NotNull] DependencyObject obj)
        {
            ValidationHelper.NotNull(obj, "obj");
            ThicknessUtil.EnsureNonNegative();
            return BoxingHelper<Thickness>.Unbox(obj.GetValue(InnerBorderThicknessProperty));
        }

        [PublicAPI]
        public static void SetInnerBorderThickness([NotNull] DependencyObject obj, Thickness value)
        {
            ValidationHelper.NotNull(obj, "obj");
        ...
        [PublicAPI] public static DependencyProperty NormalBackgrounBrushProperty =
            DependencyProperty.RegisterAttached("NormalBackgrounBrush", typeof (SolidColorBrush), typeof (ComboBoxListBoxAttriXaml),
        ...
        [PublicAPI] public static DependencyProperty NormalBorderBrushProperty =
            DependencyProperty.RegisterAttached("NormalBorderBrush", typeof (SolidColorBrush), typeof (ComboBoxListBoxAttriXaml),
        ...
        [PublicAPI] public static DependencyProperty NormalForegroundBrushProperty =
            DependencyProperty.RegisterAttached("NormalForegroundBrush", typeof (SolidColorBrush), typeof (ComboBoxListBoxAttriXaml),
        ...
        [PublicAPI] public static DependencyProperty MouseOverBackgroundBrushProperty =
            DependencyProperty.RegisterAttached("MouseOverBackgroundBrush", typeof (SolidColorBrush), typeof (ComboBoxListBoxAttriXaml),
        ...
        [PublicAPI] public static DependencyProperty MouseOverForegroundBrushProperty =
            DependencyProperty.RegisterAttached("MouseOverForegroundBrush", typeof (SolidColorBrush), typeof (ComboBoxListBoxAttriXaml),
        ...
        [PublicAPI] public static DependencyProperty MouseOverBorderBrushProperty =
            DependencyProperty.RegisterAttached("MouseOverBorderBrush", typeof (SolidColorBrush), typeof (ComboBoxListBoxAttriXaml),
        ...
        [PublicAPI] public static DependencyProperty PressedBorderBrushProperty =
            DependencyProperty.RegisterAttached("PressedBorderBrush", typeof (SolidColorBrush), typeof (ComboBoxListBoxAttriXaml),
        ...
        [PublicAPI] public static DependencyProperty PressedBackgroundBrushProperty =
            DependencyProperty.RegisterAttached("PressedBackgroundBrush", typeof (SolidColorBrush), typeof (ComboBoxListBoxAttriXaml),
        ...
        [PublicAPI] public static DependencyProperty PressedForegroundBrushProperty =
            DependencyProperty.RegisterAttached("PressedForegroundBrush", typeof (SolidColorBrush), typeof (ComboBoxListBoxAttriXaml),
        ...
        [PublicAPI] public static DependencyProperty DisableForegroundBrushProperty =
            DependencyProperty.RegisterAttached("DisableForegroundBrush", typeof (SolidColorBrush), typeof (ComboBoxListBoxAttriXaml),
        ...
        [PublicAPI] public static DependencyProperty DisableBackgroundBrushProperty =
            DependencyProperty.RegisterAttached("DisableBackgroundBrush", typeof (SolidColorBrush), typeof (ComboBoxListBoxAttriXaml),
        ...
        [PublicAPI] public static DependencyProperty DisableBorderBrushProperty =
            DependencyProperty.RegisterAttached("DisableBorderBrush", typeof (SolidColorBrush), typeof (ComboBoxListBoxAttriXaml),
        ...
        public static DependencyProperty CaretBrushProperty =
            DependencyProperty.RegisterAttached("CaretBrush", typeof(SolidColorBrush), typeof(ComboBoxListBoxAttriXaml),
        ...
        public static DependencyProperty SelectionBrushProperty =
            DependencyProperty.RegisterAttached("SelectionBrush", typeof(SolidColorBrush), typeof(ComboBoxListBoxAttriXaml),
