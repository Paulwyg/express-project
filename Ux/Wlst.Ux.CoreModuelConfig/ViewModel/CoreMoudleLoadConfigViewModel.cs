    ...
    public class CoreMoudleLoadConfigViewModel : IICoreMoudleConfig, INotifyPropertyChanged
    {
       // private  _moduleLoadManager;
        ...
        private void AddItem(IIModuleItemInfo  t)
        {
            ...
            item.IsLoadBySystemAuto = false;//t.AssemblyConfigInfo.AutoLoad == ModuleLoadSqu.AutoLoadBeforeLogin || t.AssemblyConfigInfo.AutoLoad == ModuleLoadSqu.AutoLoadAfterLogin ;
