...
namespace Wlst.Ux.LdEquipemntTree
{
    [ModuleExport(typeof(UxLdEquipemntTree), DependsOnModuleNames = new string[] { "SrEquipmentInfoHolding" })]
    public class UxLdEquipemntTree : IModule
    {
        #region IModule 成员
