...
namespace Wlst.Ux.LdEquipemntTree.SettingViewModel.ViewModel
{
    ...
    public class SettingViewModel : ObservableObject, IISettingViewModel
    {
        ...
        private bool CanEx()
        {
            if (
                ...
                this.IsShowSingleTreeOnTab == UxLdTreeSetting.IsShowSingleTreeOnTab &&
                ...
                this.IsSelectGrpMapOnlyShow == UxTreeSetting.IsSelectGrpMapOnlyShow &&
                 ...
                 this.IsRutsNotShowNullK==UxLdTreeSetting.IsRutsNotShowNullK &&
                 this.IsShowRapidOp == UxLdTreeSetting.IsShowRapidOp &&
                this .TreeSortBy ==UxTreeSetting .TreeSortBy &&
                this.SearchLimit== UxLdTreeSetting.SearchLimit
