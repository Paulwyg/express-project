...
namespace Wlst.Ux.LdEquipemntTree.SettingViewModel.Services
{
    ...
    public class Setting
    {
        ...
        public bool IsShowSingleTreeOnTabOrNot
        {
            set
            {
                if (UxLdTreeSetting.IsShowSingleTreeOnTab == value) return;
                UxLdTreeSetting.IsShowSingleTreeOnTab = value;
                RegionManage.ShowViewByIdAttachRegion(
                    LdEquipemntTree.Services.ViewIdAssign.GrpSingleTabShowViewId,

                    UxLdTreeSetting.IsShowSingleTreeOnTab);

                //CETC50_Core .UtilityFunction .SQLiteHelper.ExecuteNonQuery( )
            }
            get { return UxLdTreeSetting.IsShowSingleTreeOnTab; }
        }
        ...
        public bool IsShowMulTreeOnTabOrNot
        {
            set
            {
                ...
                //    LdEquipemntTree.Services.ViewIdAssign.GrpMulityTabShowViewId,
        ...
        {
            set { UxLdTreeSetting.IsRutsNotShowNullK = value; }
            get { return UxLdTreeSetting.IsRutsNotShowNullK; }
        }
        /// <summary>
        ...
        {
            set { UxLdTreeSetting.IsShowRapidOp = value; }
            get { return UxLdTreeSetting.IsShowRapidOp; }
        }
        /// <summary>
        /// 快速查询显示上限
        /// </summary>
        ...
        {
            set { UxLdTreeSetting.SearchLimit = value; }
            get { return UxLdTreeSetting.SearchLimit; }
        }
    }
}
