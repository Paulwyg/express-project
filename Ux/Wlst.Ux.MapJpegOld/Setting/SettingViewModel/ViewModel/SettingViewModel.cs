...
namespace Wlst.Ux.RadMapJpeg.Setting.SettingViewModel.ViewModel
{
    ...
    public class SettingViewModel : ObservableObject, IISettingViewModel
    {
        ...
        private void Ex()
        {
            ...
            MapJepg.ViewModels.RadMapJpegViewModel.CanZoom = this.IsAllowZoom;
            MapJepg.ViewModels.RadMapJpegViewModel.CanNavToEquImage = IsAllowNavToEquImage;
            MapJepg.ViewModels.RadMapJpegViewModel.SavConfig();
        }

        private bool CanEx()
        {
            if (this.IsAllowNavToEquImage != MapJepg.ViewModels.RadMapJpegViewModel.CanNavToEquImage ||
                this.IsAllowZoom != MapJepg.ViewModels.RadMapJpegViewModel.CanZoom)
                return true;
            else return false;
        ...
        {
            this.IsAllowNavToEquImage = MapJepg.ViewModels.RadMapJpegViewModel.CanNavToEquImage;
            this.IsAllowZoom = MapJepg.ViewModels.RadMapJpegViewModel.CanZoom;
        }
    };
}